...
/**
 * Чтобы проверка email происходила при валидации с остальными полями, а не при попытке записи в БД, создадим Spring
 * @Component - собственный валидатор UniqueMailValidator.
 */
@Component
