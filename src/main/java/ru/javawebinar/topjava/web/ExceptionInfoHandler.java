...
//Аннотация @RestControllerAdvice - это комбинация @ControllerAdvice and @ResponseBody (будут возвращаться не view, а тело ответа).
//Параметр annotations = RestController.class означает, что будут обрабатываться только эксепшены от контроллеров аннотированных @RestController.
