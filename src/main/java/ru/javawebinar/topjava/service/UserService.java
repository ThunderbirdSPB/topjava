...
// добавил @Scope(proxyMode = ScopedProxyMode.TARGET_CLASS), т.к. без этой аннотации для
// кэширования создается прокси над интерфейсом UserDetailsService
public class UserService implements UserDetailsService {
    ...
    /**
     * Через Environment проверяем активный профиль и для "Heroku" устанавливаем флаг в true. В методах, изменяющих пользователя,
     * проверяем этот флаг и id изменяемой сущности, и, попытке несанкционированных изменений, бросаем UpdateRestrictionException.
     */
